...
<%
	...
	while(rs.next()){
       ...
       <td><a href="user_view1.jsp?filename=<%=rs.getString("filename")%>&file=<%=rs.getString("file")%>&email=<%=rs.getString("email")%>&data=<%=rs.getString("cipher")%>"><font color="#0d637d" size="3">click</font></a> </td>
