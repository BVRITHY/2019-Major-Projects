...
<div id="main">
  <div class="shell">
    ...
    <form action="user_download2.jsp"  method="post"  >
    <center><table width="371" border="0" >

    <tr><td><font color="black"> File Name :</td>
    <td><input type="text" name="fname"  readonly="" value="<%=fname%>" /></td></tr>
    
   
    <td><input type="hidden" name="typee"  readonly="" value="<%=status1%>" /></td></tr>
    
    <tr><td><font color="black"> Key :</td>
    <td><input type="text" name="key" required="" /></td></tr> 
    <td rowspan="2">
